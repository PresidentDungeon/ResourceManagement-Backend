...
describe('ResumeService', () => {
  ...
  describe('Get resume count amount', () => {
    ...
    let contract: Contract = {ID: 1, title: 'Contract one', description: 'Some company', isVisibleToDomainUsers: false, status: {ID: 1, status: 'Draft'}, startDate: new Date(), endDate: new Date(), resumes: [{ID: 1}, {ID: 3}], users: [], resumeRequests: [], whitelists: []};
    let contract2: Contract = {ID: 2, title: 'Contract two', description: 'Some company', isVisibleToDomainUsers: false, status: {ID: 1, status: 'Draft'}, startDate: new Date(), endDate: new Date(), resumes: [{ID: 2}, {ID: 1}], users: [], resumeRequests: [], whitelists: []};
    let contract3: Contract = {ID: 3, title: 'Contract three', description: 'Some company', isVisibleToDomainUsers: true, status: {ID: 1, status: 'Draft'}, startDate: new Date(), endDate: new Date(), resumes: [{ID: 5}, {ID: 7}, {ID: 2}, {ID: 9}], users: [], resumeRequests: [], whitelists: []};
    let contract4: Contract = {ID: 4, title: 'Contract four', description: 'Some company', isVisibleToDomainUsers: true, status: {ID: 1, status: 'Draft'}, startDate: new Date(), endDate: new Date(), resumes: [{ID: 1}], users: [], resumeRequests: [], whitelists: []};
